...
RSpec.describe 'Merchant Bulk Discounts Index Page' do
  describe "US_1 (pt 2)" do 
    it 'displays all bulk discounts with percentage of discount and quantity threshold' do
      ...
      bulk_discount_2 = merchant_1.bulk_discounts.create!(percentage_discount: 20, quantity_threshold: 20)
      bulk_discount_2 = merchant_1.bulk_discounts.create!(percentage_discount: 25, quantity_threshold: 30)
      bulk_discount_2 = merchant_1.bulk_discounts.create!(percentage_discount: 30, quantity_threshold: 50)
